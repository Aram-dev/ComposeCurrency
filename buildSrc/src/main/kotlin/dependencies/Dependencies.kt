...
object Dependencies {
    ...
    const val NAVIGATION_COMPOSE = "androidx.navigation:navigation-compose:${BuildDependenciesVersions.NAVIGATION}"
    const val LIFECYCLE_EXTENSIONS = "androidx.lifecycle:lifecycle-runtime-ktx:${BuildDependenciesVersions.LIFECYCLE}"
    const val LIFECYCLE_RUNTIME_COMPOSE = "androidx.lifecycle:lifecycle-runtime-compose:${BuildDependenciesVersions.LIFECYCLE_COMPOSE}"
    ...
    const val HILT_COMMON = "androidx.hilt:hilt-common:${BuildDependenciesVersions.HILT_ANDROID_X}"
    const val HILT_NAVIGATION = "androidx.hilt:hilt-navigation-compose:${BuildDependenciesVersions.HILT_ANDROID_X}"
    ...
    const val KOTLIN_COMPILER_EMBEDDABLE = "org.jetbrains.kotlin:kotlin-compiler-embeddable:${BuildDependenciesVersions.KOTLIN_COMPILER_EMBEDDABLE}"

    const val COMPOSE_BOM = "androidx.compose:compose-bom:${BuildDependenciesVersions.COMPOSE_BOM}"
    ...
    const val PAGING_RX = "androidx.paging:paging-rxjava2-ktx:${BuildDependenciesVersions.PAGING}"
